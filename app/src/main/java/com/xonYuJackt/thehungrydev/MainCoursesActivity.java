...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListView MainCoursesList = findViewById(R.id.list_main_courses);
        Dish[] dishMainCourses = {
        ...
        ArrayAdapter<Dish> dishArrayAdapter = new ArrayAdapter<>(this,android.R.layout.simple_list_item_1,dishMainCourses);
